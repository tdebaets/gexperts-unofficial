...
AppName=GExperts
AppVerName=GExperts for C++Builder 5
AppID=GExpertsBCB5
CompressLevel=9
...
[Files]
Source: "BCB5\ExpMgr.exe"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "BCB5\GDebug.exe"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "BCB5\Grep.exe"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "GExperts.hlp"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "GExperts.cnt"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "GExpert5_bcb.dll"; DestDir: "{app}"; CopyMode: alwaysoverwrite
...
[Registry]
Root: HKCU; Subkey: "Software\Borland\C++Builder\5.0\Experts"; ValueType: STRING; ValueName: "GExperts"; ValueData: "{app}\GExpert5_bcb.dll"; Flags: uninsdeletevalue
Root: HKCU; Subkey: "Software\Borland\C++Builder\5.0\GExperts\Misc"; ValueType: STRING; ValueName: "ConfigPath"; ValueData: "{app}"
Root: HKCU; Subkey: "Software\Borland\C++Builder\5.0\GExperts\Misc"; ValueType: STRING; ValueName: "HelpFile"; ValueData: "{app}\GExperts.hlp"
