...
AppName=GExperts
AppVerName=GExperts for Delphi 5
AppID=GExpertsDelphi5
CompressLevel=9
...
[Files]
Source: "D5\ExpMgr.exe"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "D5\GDebug.exe"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "D5\Grep.exe"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "GExperts.hlp"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "GExperts.cnt"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "GExpert5.dll"; DestDir: "{app}"; CopyMode: alwaysoverwrite
...
[Registry]
Root: HKCU; Subkey: "Software\Borland\Delphi\5.0\Experts"; ValueType: STRING; ValueName: "GExperts"; ValueData: "{app}\GExpert5.dll"; Flags: uninsdeletevalue
Root: HKCU; Subkey: "Software\Borland\Delphi\5.0\GExperts\Misc"; ValueType: STRING; ValueName: "ConfigPath"; ValueData: "{app}"
Root: HKCU; Subkey: "Software\Borland\Delphi\5.0\GExperts\Misc"; ValueType: STRING; ValueName: "HelpFile"; ValueData: "{app}\GExperts.hlp"
