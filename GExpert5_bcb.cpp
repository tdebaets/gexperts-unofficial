...
USEFORMNS("src\GX_ProofReaderDM.pas", Gx_proofreaderdm, dmProofReader);
...
USEFORMNS("IdeDock\Native\GX_DummyIdeDock.pas", Gx_dummyidedock, fmDummyIdeDockForm);
USEFORMNS("IdeDock\Native\GX_IdeDock.pas", Gx_idedock, fmIdeDockForm);
//---------------------------------------------------------------------------
#pragma argsused // Parameters hinst, reason, <void*> are never used
...
#pragma argsused // Parameter Terminate is never used
