...
uses
  ...
  GX_SingleIDE in 'OneD4all\GX_SingleIDE.pas' {fmSingleIDE},
  GX_Toolbar in 'Src\GX_Toolbar.pas',
  GX_ToolbarButtons in 'Src\GX_ToolbarButtons.pas',
  GX_FakeIdeDock in 'IdeDock\NoDock\GX_FakeIdeDock.pas' {fmFakeIdeDockForm},
  GX_IdeDock in 'IdeDock\GX_IdeDock.pas' {fmIdeDockForm},
