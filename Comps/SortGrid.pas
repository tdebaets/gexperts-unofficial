...
public
    ...
    procedure DeleteRow(ARow: Longint); {$IFDEF GX_VER120_up} override; {$ENDIF GX_VER120_up}
    procedure DeleteColumn(ACol: Longint); {$IFDEF GX_VER120_up} override; {$ENDIF GX_VER120_up}
